...
| scope | 남은 내용 | runs |
| --- | --- | ---: |
| current rawbase queue | `normal_ratio`, `per_class`, `LR`, `warmup`, `GC 5조건`, `label_smoothing`, `stochastic_depth`, `focal_gamma`, `abnormal_weight`, `ema`, `color`, `allow_tie_save` | pending |
