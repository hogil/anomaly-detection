...
### 3.5 Normal Count Sweep (n=700 vs n=2800)

| iter | 변경 | normal count | test_f1 | FN | FP |
|---|---|---|---|---|---|
| v3 | baseline | 700 | 99.49% | 5.0 | 2.7 |
| v4 | renderer fix | 700 | 99.82% | 2.3 | 0.3 |
| v5 | boundary raise | 700 | 99.91% | 1.3 | 0.0 |
| **v6+ n=2800** | **normal 4배 증가** | **2800** | **99.93%** | **1** | **0** |

n=2800 (v8 시절 sweet spot) 으로 늘려봤지만 **n=700 (99.91%) 과 0.02% 차이** — 사실상 동등. normal 데이터 양은 현재 병목이 아님. 학습 시간만 1.5배 증가 (132 batch → 197 batch).
