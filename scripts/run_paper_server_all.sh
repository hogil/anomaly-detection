...
DEFAULT_ROUND1_AXES="normal_ratio,per_class,lr,warmup,weight_decay,smoothing,label_smoothing,asl,stochastic_depth,focal_gamma,abnormal_weight,ema,allow_tie_save,color"
